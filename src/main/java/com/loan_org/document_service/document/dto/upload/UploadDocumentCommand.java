...
import com.loan_org.document_service.document.constraints.DocumentValidationRules;
...
public record UploadDocumentCommand(
        ...
        @NotBlank(message = DocumentValidationRules.APPLICATION_ID_NOT_BLANK_MESSAGE)
        String       applicationId,

        @NotBlank(message = DocumentValidationRules.CUSTOMER_ID_NOT_BLANK_MESSAGE)
        String       customerId,

        @NotNull(message = DocumentValidationRules.DOCUMENT_TYPE_NOT_BLANK_MESSAGE)
        DocumentType documentType,

        @NotBlank(message = DocumentValidationRules.CONTENT_TYPE_NOT_BLANK_MESSAGE)
        @ValidateContentType(message = DocumentValidationRules.CONTENT_TYPE_NOT_VALID_MESSAGE)
        String       contentType,

        @NotBlank(message = DocumentValidationRules.FILE_NAME_NOT_BLANK_MESSAGE)
        String       fileName,

        @Min(value = DocumentValidationRules.MIN_FILE_SIZE_IN_BYTES,
                message = DocumentValidationRules.FILE_MINIMUM_SIZE_MESSAGE)
        long         fileSize
) {}
